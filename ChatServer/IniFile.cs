...
namespace Teknomatrik.Utilities
{
    // read settings from 'conf.ini' file located on same directory as executable
    // based on "A Simple and Efficient INI File Reader in C#" by Bruce Greene, 10 May 2014
    // source: https://www.codeproject.com/Tips/771772/A-Simple-and-Efficient-INI-File-Reader-in-Csharp
    ...
    public class IniFile
    {
        ...
        public string TheFile
        {
            ...
            set
            {
                ...
                {
                    theFile = @$"{Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)}/BSS_TEKNO/db/{value}";
                    if (File.Exists(theFile)) k = true;
                }
                if (k)
                {
                ...
                else // exception file not exist
                {
                    throw new Exception($"In class IniFile: Config file '{value}' NOT EXIST !!");
                }
            }
        }
